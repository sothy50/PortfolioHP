...
export default function Latestpost() {
  return (
    <Card
      key="1"
      className="w-[500px] mx-auto bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden md:max-w-3xl m-3"
    >
      <div className="md:flex">
        ...
        <div className="p-8 w-full">
          <div className="flex items-center justify-between">
            ...
            <IconTwittersolid className="h-6 w-6 text-blue-500 fill-current" />
          </div>
...
function IconTwittersolid(props:React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
